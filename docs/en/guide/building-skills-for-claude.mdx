...
description: The Complete Guide to Building Skills for Claude - 从规划、结构到测试和分发的完整指南
---
...
Start by hosting your skill on GitHub with a public repo, clear README (for human visitors -- this is separate from your skill folder), and example usage with screenshots. Then add a section to your MCP documentation that links to the skill.
...
4. **Model "laziness"** - Add explicit encouragement in **user prompts** (more effective than in SKILL.md):
...
- **Bug Reports:** GitHub Issues: `anthropics/skills/issues` - Include: Skill name, error message, steps to reproduce
